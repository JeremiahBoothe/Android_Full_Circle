...
import com.jeremiahboothe.media3exoplayer.ui.MainActivity
import kotlin.system.exitProcess

@UnstableApi class AudioPlayerService : MediaLibraryService(), Player.Listener {
    /*
    ...
    */
    ...
    private fun startPlayer() {
        ...
        exoPlayer = ExoPlayer.Builder(this)
            .build()
        /*  //JB Blocked out akshay player original builder
