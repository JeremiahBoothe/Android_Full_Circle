package com.jeremiahboothe.media3exoplayer.ui.util
...
import com.jeremiahboothe.media3exoplayer.R
import com.jeremiahboothe.media3exoplayer.data.Media

object Constants {

    const val MP3_URL =
        "http://stream.laut.fm/radiotfsc"
    const val MP3_URL2 =
        "http://stream.radiojar.com/umg0tz9sywzuv.mp3"
    const val MP4_URL =
    ...
    const val HLS_URL =
        "http://n03.radiojar.com/umg0tz9sywzuv.mp3?rj-ttl=5&rj-tok=AAABgJx0HscAo7xdUWdKCL1Qgg"
    ...
    const val HLS_URL2 =
        "http://n03.radiojar.com/umg0tz9sywzuv?rj-ttl=5&rj-tok=AAABgJx0HscAo7xdUWdKCL1Qgg"

    val MP3_SAMPLE_PLAYLIST = arrayOf(
        Media(
            uriParser("http://n03.radiojar.com/umg0tz9sywzuv?rj-ttl=5&rj-tok=AAABgJx0HscAo7xdUWdKCL1Qgg"),
            "audio_1",
            "SLE Radio",
